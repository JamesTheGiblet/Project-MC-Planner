...
uno: {
    ...
    pinLayout: { 
        top: '33%', 
        left: '14.7%',      // Left column position
        right: '2.5%',     // Right column position
        gap: '1.5% 60%'   // Horizontal gap between columns
    },
    pins: [
        // This interleaved layout creates two columns. Left: Power/Analog, Right: Digital.
        // Placeholders align the shorter left column with the longer right one.
        ...
        { name: '3.3V', type: 'power', title: 'Power: 3.3V Regulated Output (50mA max)' },
        ...
        { name: '11', type: 'gpio', title: 'Pin 11: Digital I/O (SPI MOSI, PWM)' },
        ...
        { name: '', type: 'placeholder', title: '' },
        { name: '1', type: 'uart', title: 'Pin 1: Digital I/O (UART TX)' },
        { name: '', type: 'placeholder', title: '' },
        { name: '0', type: 'uart', title: 'Pin 0: Digital I/O (UART RX)' },
    ]
    },
    esp32: {
